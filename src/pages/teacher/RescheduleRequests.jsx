...
const TeacherRescheduleRequests = () => {
    ...
    const handleApproveClick = (request) => {
        ...
        setTeacherResponse(`Your reschedule request has been approved. I will create a separate session for you and notify you with the new schedule details.`);
    ...
    const handleSubmitResponse = async () => {
        ...
        if (actionType === "reject" && (!teacherResponse || teacherResponse.trim().length === 0)) {
    ...
    return (
        <div className="bg-white bg-linear-to-t from-[#F1C2AC]/50 to-[#95C4BE]/50 px-2 sm:px-3 min-h-screen">
            <DashHeading
                ...
                desc="Review and manage reschedule requests for your classes"
            />
                        ...
                        emptyContent={<div className="text-center py-20">
                            ...
                            <p className="text-gray-400 text-sm mt-2">
                                {statusFilter !== "all"
                                    ...
                                    : "Students haven't submitted any requests for your classes yet"}
                            </p>
                        </div>}
                        items={data?.requests || []}>
                        {(request) => (
...
export default TeacherRescheduleRequests;
