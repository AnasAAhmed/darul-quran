            ...
            {course.map((item, index) => (
              <div key={index} className="col-span-12 md:col-span-6 lg:col-span-4">
                <div className="w-full bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow h-full flex flex-col">
                  ...
                  <div className={`p-3 ${!item.thumbnail ? "bg-[linear-gradient(110.57deg,rgba(241,194,172,0.25)_0.4%,rgba(149,196,190,0.25)_93.82%)] rounded-t-lg h-48 mb-4" : ""}`}>
                    {!item.thumbnail && (
                  ...
                  <div className="p-3 pt-0 space-y-3 flex-grow flex flex-col justify-between">
                    <div className={` ${!item.thumbnail ? "flex flex-col justify-center fldex-1" : ""}`}>
                      <div className="flex justify-between items-center">
