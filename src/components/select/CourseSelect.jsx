...
/**
 * @param {Object} props
 * @param {(courseId: Number)=>void} props.onChange
        ...
        <div className="w-full relative" ref={containerRef}>
            ...
            >
                <div className="flex flex-wrap gap-2 items-center">
                    {selectedCourse ? (
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-blue-100 text-blue-700 text-sm font-medium rounded-lg transition-all duration-200 hover:bg-blue-200">
                    ...
                    >
                        {isLoading ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-8 text-gray-400">
                                ...
                                <span className="text-sm">{searchValue ? 'No courses found' : 'No courses available'}</span>
                            </div>
                        ) : (
                            <div className="py-1">
                        ...
                        {data.total > 0 && (
                            <div className="px-3 py-2 bg-gray-50 border-t border-gray-100 text-xs text-gray-500 text-center">
                                {data.total <= limit
                                    ? `All ${data.total} courses loaded`
                                    : `Showing ${limit} of ${data.total} courses - refine your search`
                                }
                            </div>
                        )}
                    </div>
