...
export const userAPI = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getAllTeachers: builder.query({
            query: ({ page, limit, search, initialValue }) => ({
                url: "/getTeachers",
                method: "GET",
                params: { page, limit, search, initialValue }
            }),
            providesTags: ["user"],
        }),
        getStudents: builder.query({
            query: ({ page, limit, search, initialValues }) => ({
                url: "/getStudents",
                method: "GET",
                params: { page, limit, search, initialValues }
            }),
            providesTags: ["user"],
        }),
        ...
        getAllUserForSelect: builder.query({
            query: ({ page, limit, search, courseId, enrolledStudents,initialValues }) => ({
                url: "/getAllUserForSelect",
                method: "GET",
                params: {
                    page, limit, search, courseId, enrolledStudents,initialValues
                },
            }),
            providesTags: ["user"],
        }),
